...
class DataAgent:
    def __init__(
        ...
        load_dotenv()
        if "openrouter" in deployment_name.lower() or deployment_name.startswith("google/") or deployment_name.startswith("anthropic/") or deployment_name.startswith("openai/") or deployment_name.startswith("meta-llama/"):
            self.client = OpenAI(
